...
const initialSeedData = {
  ...
  videos: [
    {
      id: "vid_01",
      title: "Profil Program Studi D4 Teknik Listrik POLIMDO",
      titleEn: "D4 Electrical Engineering Study Program Profile - POLIMDO",
      category: "course_promo",
      categoryName: "Promosi Prodi",
      categoryNameEn: "Program Promo",
      url: "https://assets.mixkit.co/videos/preview/mixkit-engineer-working-on-a-circuit-board-42352-large.mp4",
      embedUrl: "",
      duration: "03:45",
      thumbnail: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80",
      description: "Pengenalan keunggulan kurikulum terapan D4 Teknik Listrik Politeknik Negeri Manado, fasilitas lab modern, dan prospek karir global.",
      descriptionEn: "Introduction to the curriculum excellence of D4 Electrical Engineering at POLIMDO, modern lab facilities, and global career prospects.",
      scheduleSlot: "Semua Hari (Rotasi Utama)",
      isActive: true
    },
    {
      id: "vid_02",
      title: "Prosedur Keselamatan Kerja (K3) di Laboratorium Instalasi Listrik",
      titleEn: "Occupational Safety & Health (OSH) SOP in Electrical Lab",
      category: "k3_safety",
      categoryName: "K3 & Keselamatan",
      categoryNameEn: "OSH & Safety",
      url: "https://assets.mixkit.co/videos/preview/mixkit-circuit-board-with-glowing-tracks-and-components-42345-large.mp4",
      embedUrl: "",
      duration: "02:30",
      thumbnail: "https://images.unsplash.com/photo-1508873696983-2df5293cb32b?auto=format&fit=crop&w=800&q=80",
      description: "Panduan wajib penggunaan APD 1000V, isolasi tegangan, SOP darurat kebakaran APAR, dan penanganan sengatan listrik.",
      descriptionEn: "Mandatory guidelines for 1000V PPE usage, voltage lockout-tagout, fire extinguisher emergency SOP, and electric shock first aid.",
      scheduleSlot: "07:45 - 08:15 WITA & Pergantian Sesi",
      isActive: true
    },
    {
      id: "vid_03",
      title: "Tutorial Praktikum: Pengoperasian PLC Omron & Smart Relay Zelio",
      titleEn: "Lab Tutorial: Operating Omron PLC & Zelio Smart Relays",
      category: "instructional",
      categoryName: "Video Pembelajaran",
      categoryNameEn: "Instructional Video",
      url: "https://assets.mixkit.co/videos/preview/mixkit-hands-of-a-man-working-on-a-motherboard-42353-large.mp4",
      embedUrl: "",
      duration: "05:12",
      thumbnail: "https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?auto=format&fit=crop&w=800&q=80",
      description: "Langkah demi langkah perancangan ladder diagram, pengawatan input/output sensor, dan monitoring I/O industri.",
      descriptionEn: "Step-by-step ladder diagram programming, sensor input/output wiring, and industrial I/O monitoring.",
      scheduleSlot: "12:00 - 13:00 WITA (Istirahat Siang)",
      isActive: true
    },
    {
      id: "vid_04",
      title: "Promosi Mata Kuliah: Energi Baru Terbarukan & Solar PV Rooftop",
      titleEn: "Course Promo: Renewable Energy & Rooftop Solar PV Systems",
      category: "course_promo",
      categoryName: "Promosi Mata Kuliah",
      categoryNameEn: "Course Promotion",
      url: "https://assets.mixkit.co/videos/preview/mixkit-wind-turbines-in-a-field-under-a-clear-blue-sky-42343-large.mp4",
      embedUrl: "",
      duration: "04:10",
      thumbnail: "https://images.unsplash.com/photo-1509391365360-2e959784a276?auto=format&fit=crop&w=800&q=80",
      description: "Mempelajari desain on-grid/off-grid solar inverter, baterai penyimpanan, dan sertifikasi instalatur surya nasional.",
      descriptionEn: "Learning on-grid/off-grid solar inverter design, battery storage, and national solar installer certification.",
      scheduleSlot: "16:30 - 17:30 WITA",
      isActive: true
    },
    {
      id: "vid_05",
      title: "Penerimaan Mahasiswa Baru & Beasiswa POLIMDO 2026",
      titleEn: "POLIMDO New Student Admission & Scholarship Opportunities",
      category: "campus_ad",
      categoryName: "Iklan & Info Kampus",
      categoryNameEn: "Campus Ads & Info",
      url: "https://assets.mixkit.co/videos/preview/mixkit-close-up-of-microchip-components-and-processors-42347-large.mp4",
      embedUrl: "",
      duration: "02:15",
      thumbnail: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=800&q=80",
      description: "Informasi pendaftaran jalur SNBP, SNBT, dan Jalur Mandiri POLIMDO serta program beasiswa KIP-Kuliah.",
      descriptionEn: "Admission information for national and independent tracks at POLIMDO plus KIP-Kuliah scholarships.",
      scheduleSlot: "Rotasi Berkala",
      isActive: true
    }
  ],
  announcements: [
